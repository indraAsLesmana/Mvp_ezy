...
import com.example.indraaguslesmana.mvpezy.model.Authrequest;
import com.example.indraaguslesmana.mvpezy.model.BestSellerResponse;
import com.example.indraaguslesmana.mvpezy.model.CategoryResponse;
import com.example.indraaguslesmana.mvpezy.model.ChangepasswordResponse;
import com.example.indraaguslesmana.mvpezy.model.ContactUsResponse;
import com.example.indraaguslesmana.mvpezy.model.DetailProductResponse;
import com.example.indraaguslesmana.mvpezy.model.FaqResponse;
import com.example.indraaguslesmana.mvpezy.model.ForgotpasswordResponse;
import com.example.indraaguslesmana.mvpezy.model.HeaderimageResponse;
import com.example.indraaguslesmana.mvpezy.model.ListCategoryResponse;
import com.example.indraaguslesmana.mvpezy.model.PaymentResponse;
import com.example.indraaguslesmana.mvpezy.model.ProductResponse;
import com.example.indraaguslesmana.mvpezy.model.RegfcmResponse;
import com.example.indraaguslesmana.mvpezy.model.SearchResponse;
import com.example.indraaguslesmana.mvpezy.model.SendFeedBackResponse;
import com.example.indraaguslesmana.mvpezy.model.ServertimeResponse;
import com.example.indraaguslesmana.mvpezy.model.TamplateResponse;
import com.example.indraaguslesmana.mvpezy.model.TermResponse;
import com.example.indraaguslesmana.mvpezy.model.TokencheckResponse;
import com.example.indraaguslesmana.mvpezy.model.TransactionHistoryResponse;
import com.example.indraaguslesmana.mvpezy.model.TutorialResponse;
import com.example.indraaguslesmana.mvpezy.model.TutorialStepResponse;
import com.example.indraaguslesmana.mvpezy.model.VoucherprintResponse;
import com.example.indraaguslesmana.mvpezy.model.WalletbalanceResponse;
...
import static com.example.indraaguslesmana.mvpezy.util.Constant.API_URL_GENERALUSAGE;
...
public interface EzytopupAPI {
    ...
    Call<TransactionHistoryResponse> getHistory(@Header("Authorize") String token,
                                                @Query("customerId") String customerId);
    /**
     * this API i implement with object PaymentResponse have no object data,
     * just get Message for checking result 200 or not
     */
